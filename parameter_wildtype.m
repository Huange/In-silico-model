...
if v12 == 2 || v13 == 2 || v14 == 2 || v15 == 2
   constant = -1;
   mu = con_coef + con_mean*(constant + 0.32*v12 + 0.44*v13 + 0.03*v14 + 0.21*v15);
...
constant = 2;
mu = con_coef + con_mean*(constant - 0.26*v24 - 0.74*v25);
...
if v34 == 2 || v35 == 2
   constant = -1;
   mu = con_coef + con_mean*(constant + 0.63*v34 + 0.37*v35);
...
if v42 == 2 || v43 == 2
   constant = 0.38;
   mu = con_coef + con_mean*(constant - 0.34*v40 - 0.12*v41 + 0.24*v42 + 0.30*v43);
...
if v46 == 2
   constant = 0.54;
   mu = con_coef + con_mean*(constant - 0.21*v44 - 0.30*v45 + 0.48*v46);
...
if v49 == 2 || v50 == 2 || v51 == 2
   constant = -0.999;
   mu = con_coef + con_mean*(constant + 0.695*v49 + 0.175*v50 + 0.129*v51);
